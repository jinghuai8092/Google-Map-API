...
function UTCtoLocationTime(utc_offset) {
    ...
    return `${LD.getDate()}/${LD.getMonth() + 1 < 10 ? '0' + (LD.getMonth() + 1) : LD.getMonth() + 1}/${LD.getFullYear()} ${LD.getHours()<10?'0'+LD.getHours():LD.getHours()}:${LD.getMinutes()<10?'0'+LD.getMinutes():LD.getMinutes()}:${LD.getSeconds()<10?'0'+LD.getSeconds():LD.getSeconds()}`
}
...
function showPosition(Position) {
    ...
    var d=new Date();
    locationAndTime.innerHTML = 'The local time is '+d.toLocaleDateString()+' '+d.toLocaleTimeString();
